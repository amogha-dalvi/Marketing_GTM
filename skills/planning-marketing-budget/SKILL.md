...
|-------|----------|--------|
| Revenue-backward budget model | Day 1 | Budget derived from revenue targets |
| Headcount planning | Day 2 | Hiring roadmap with timing triggers |
| Build vs. buy vs. automate | Day 3 | Decision matrix per marketing function |
| Tool & tech stack budgeting | Day 4 | Tiered tool list with cost justification |
| Channel ROI estimation & phasing | Day 5 | Channel allocation, quarterly sequencing |
| Monthly budget review process | Ongoing | Review framework with decision rules |
